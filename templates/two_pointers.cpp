...
template <typename Add, typename Remove, typename Test, typename Yield>
    requires invocable<Add, i64> && invocable<Remove, i64> &&
             is_invocable_r_v<bool, Test, i64> && invocable<Yield, i64, i64>
auto two_pointers(i64 n, Add add, Remove remove, Test test, Yield yield) -> void
{
    auto l = 0ll, r = 0ll;
    do
    {
